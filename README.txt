...
Metodyka:
- ponieważ aplikacja miała być prosta i szybka do napisania to powstała w oparciu o framework flask
...
Plany na przyszłość:
-podmianka adresów na bardziej intuicyjne np. zamiast /seanse, to /kasjer/seanse itp.

Bibliografia:
-Flask:
    książka: Flask Web Development: Developing Web Applications with Python
-Tabele:
